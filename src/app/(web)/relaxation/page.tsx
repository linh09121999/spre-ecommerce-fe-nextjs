...
const Relaxation: React.FC = () => {
    ...
    useEffect(() => {
        setSelectNav(2)
        getApiTaxonsFashion("categories/wellness/relaxation")
        getApiProducts("190", 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
    }, [])
        ...
        const handleScroll = () => {
            ...
            if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 400) {
                if (currentPage < totalPages) {
                    ...
                    getApiProducts("190", currentPage + 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
                }
            }
        };
