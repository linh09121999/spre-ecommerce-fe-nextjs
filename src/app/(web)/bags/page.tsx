...
const Bags: React.FC = () => {
    ...
    useEffect(() => {
        setSelectNav(1)
        getApiTaxonsFashion("categories/fashion/accessories/bags")
        getApiProducts("215", 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
    }, [])
