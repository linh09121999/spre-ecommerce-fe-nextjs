...
const Nutrition: React.FC = () => {
    ...
    const getApiTaxonsFashion = async (taxon_permalink: string) => {
        try {
            ...
            toast.error(`Retrieve a taxon: ` + error.response.data.errore)
        }
        finally {
    ...
    useEffect(() => {
        setSelectNav(2)
        getApiTaxonsFashion("categories/wellness/nutrition")
        getApiProducts("193", 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
    }, [])
        ...
        const handleScroll = () => {
            ...
            if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 400) {
                if (currentPage < totalPages) {
                    ...
                    getApiProducts("193", currentPage + 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
                }
            }
        };
