...
const Sale: React.FC = () => {
  ...
  useEffect(() => {
    setSelectNav(4)
    getApiTaxonsFashion("collections/on-sale")
    getApiProducts("173", 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
  }, [])
