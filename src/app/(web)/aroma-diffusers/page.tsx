...
const AromaDiffusers: React.FC = () => {
    ...
    const getApiTaxonsFashion = async (taxon_permalink: string) => {
        try {
            ...
            toast.error(`Retrieve a taxon: ` + error.response.data.error)
        }
        finally {
    ...
    useEffect(() => {
        setSelectNav(2)
        getApiTaxonsFashion("categories/wellness/relaxation/aroma-diffusers")
        getApiProducts("195", 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
    }, [])
        ...
        const handleScroll = () => {
            ...
            if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 400) {
                if (currentPage < totalPages) {
                    ...
                    getApiProducts("195", currentPage + 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
                }
            }
        };
