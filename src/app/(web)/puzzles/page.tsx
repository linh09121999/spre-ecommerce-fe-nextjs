...
const Puzzles: React.FC = () => {
    ...
    useEffect(() => {
        setSelectNav(2)
        getApiTaxonsFashion("categories/wellness/mental-stimulation/puzzles")
        getApiProducts("197", 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
    }, [])
        ...
        const handleScroll = () => {
            ...
            if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 400) {
                if (currentPage < totalPages) {
                    ...
                    getApiProducts("197", currentPage + 1, prePage, "default_variant,variants,option_types,product_properties,taxons,images,primary_variant")
                }
            }
        };
